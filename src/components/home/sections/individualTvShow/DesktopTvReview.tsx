...
import { Cast, TvDetails } from "../../../../interfaces/TvDetails";
import { useMovieStore } from "../../../../store/store";
import IndividualCredits from "../individualMovie/IndividualCredits";

interface Props {
  data?: TvDetails;
  credits: (Cast | undefined)[];
}
const DesktopTvReview = ({ data, credits }: Props) => {
...
export default DesktopTvReview;
